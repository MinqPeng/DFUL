...
parser.add_argument('--n_rkhs', type=int, default=2048,
...
def main():
    ...
    # get the dataset
    dataset = get_dataset(args.dataset) #C10
    encoder_size = get_encoder_size(dataset) #32
    ...
    train_loader, test_loader, num_classes = build_dataset(dataset=dataset,
